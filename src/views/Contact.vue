<template>
  <div class="flex-1 flex flex-col">
    ...
    <div class="flex flex-col" data-aos="fade-up" data-aos-duration="1000">
      <h1
        class="text-2xl md:text-4xl md:font-bold font-semibold text-gray-800 mx-4 xl:mx-4 2xl:mx-30 md:mt-10"
      >
        Contact
      </h1>
    ...
    <div class="flex flex-col lg:flex-row gap-8 md:mt-10 xl:mx-4 2xl:mx-30">
      <!-- Left Side: Contact Info Card -->
      <div
        class="lg:w-1/3 bg-white rounded-lg shadow-md p-6 border border-gray-200"
        data-aos="fade-up"
      ...
      <div class="w-full lg:w-2/3 space-y-6" data-aos="fade-up" data-aos-duration="1000">
        <!-- Contact Form -->
